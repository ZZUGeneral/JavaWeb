...
public interface IMiscService {
    ...
    public int doLogin(@PathParam("uid") int uid, @PathParam("pwd") String pwd);
    ...
    @GET
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    @Path("/getPackageRoute/{expressSheetID}")
    ...
    public Response appointDeliver(@PathParam("transPackageID")String transPackageID,
