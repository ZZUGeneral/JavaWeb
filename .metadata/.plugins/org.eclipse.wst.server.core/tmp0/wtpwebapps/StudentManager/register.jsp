			...
			<div id="contentwrapper" class="contentwrapper">
				...
				<div id="validation" class="subcontent">
					...
					<form id="form1" class="stdform" method="post"
						action="/StudentManager/AddStudentOrTeacherServlet">
						<input type="hidden" value="<%=type%>" id="type" name="type" />
						<p>
							<label>姓名</label> <span class="field"><input type="text"
								name="name" id="name" class="longinput" /></span>
						</p>
						<p>
							<label>性别</label> <span class="field"><input type="radio"
								name="gender" id="gender" checked="checked" class="longinput"
								value="男" />男 <input type="radio" name="gender" id="gender"
								class="longinput" value="女" />女</span>
						</p>

						<p>
							<label>Email</label> <span class="field"><input
								type="text" name="email" id="email" class="longinput" /></span>
						</p>
