...
public class VirginiaPassword {
	...
	public static void main(String[] args) {
		...
		System.out.println("请输入加密后字符串：");
		ciphertext = scan.next();
		keyLength = Friedman(ciphertext);
		vigenereCipher(keyLength, ciphertext);
	}
	...
	public static void vigenereCipher(int keyLength, String ciphertext) {
