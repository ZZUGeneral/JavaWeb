							...
							<table cellpadding="0" cellspacing="0" border="0"
								...
								<tbody>
									...
									<tr class="gradeX">
										...
										<td class="center"><img
											src="/School/images/user/${student.headShot }" width="150"
											height="150"></td>
									</tr>
									<tr class="gradeX">
										<td align="center">学号</td>
										<td class="center"><c:out value="${student.stu_no }"></c:out></td>
									</tr>
									<tr>
										<td align="center">姓名</td>
										<td class="center"><c:out value="${student.stu_name }"></c:out></td>
									</tr>
									<tr>
										<td align="center">性别</td>
										<td class="center"><c:out value="${student.gender }"></c:out></td>
									</tr>

									<tr>
										<td align="center">院系</td>
										<td class="center"><c:out value="${student.dept }"></c:out></td>
									</tr>

									<tr>
										<td align="center">生日</td>
										<td class="center"><c:out value="${student.birthday }"></c:out></td>
									</tr>
									<tr>
										<td align="center">邮箱</td>
										<td class="center"><c:out value="${student.email }"></c:out></td>
									</tr>

								</tbody>
							</table>
							<div align="center">
								<a href="/School/StudentBasicinfoServlet"><button
										class="stdbtn btn_yellow">返回上一级</button></a>
								<c:if test="${student.stu_no == sessionScope.SESSION_NO  }">
									<a href="/School/GetUpdateInfoServlet"><button
