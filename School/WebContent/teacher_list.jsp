	...
	<div class="bodywrapper">
		...
		<div class="centercontent tables">
			...
			<div id="contentwrapper" class="contentwrapper">
				<form action="/School/SearchServlet?location=teacher" method="post">
								...
								<c:forEach items="${teacherList }" var="teacher">
									<tr class="gradeX">
										...
										<td class="center">
											<ul class="buttonlist">
												<li><a
													href="/School/TeacherDetailServlet?teacherNo=${teacher.teacher_no }"
				...
				<br /> <br />
				<div align="center">
					<a href="/School/TeacherBasicinfoServlet?page=first"><button
							class="stdbtn btn_yellow">首页</button></a><a
						href="/School/TeacherBasicinfoServlet?page=previous"><button
							class="stdbtn btn_yellow">上一页</button></a><a
						href="/School/TeacherBasicinfoServlet?page=next"><button
							class="stdbtn btn_yellow">下一页</button></a> <a
						href="/School/TeacherBasicinfoServlet?page=last"><button
