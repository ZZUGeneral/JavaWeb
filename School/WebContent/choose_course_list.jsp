	...
	<div class="bodywrapper">
		...
		<div class="centercontent tables">
			...
			<div id="contentwrapper" class="contentwrapper">
								...
								<c:forEach items="${cbList }" var="cb">
									<tr class="gradeX">
										...
										<td class="center">
											<ul class="buttonlist">
												<li><a
													href="/School/CourseChooseServlet?courseNo=${cb.course_no }"
				...
				<br /> <br />
				<div align="center">
					<a href="/School/StudentChooseCourseServlet?page=first"><button
							class="stdbtn btn_yellow">首页</button></a><a
						href="/School/StudentChooseCourseServlet?page=previous"><button
							class="stdbtn btn_yellow">上一页</button></a><a
						href="/School/StudentChooseCourseServlet?page=next"><button
							class="stdbtn btn_yellow">下一页</button></a> <a
						href="/School/StudentChooseCourseServlet?page=last"><button
