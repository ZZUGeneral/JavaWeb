...
<script type="text/javascript">
	function updateScore() {
		var updateScore = document.getElementById("score").value;
		var stu_no = document.getElementById("stu_no").value;
		var course_no = document.getElementById("course_no").value;
		window.location = "/School/StudentScoreServlet?updateScore="
				+ updateScore + "&stu_no=" + stu_no + "&course_no=" + course_no;
	}
</script>
	...
	<div class="bodywrapper">
		...
		<div class="centercontent tables">
			...
			<div id="contentwrapper" class="contentwrapper">
				<form action="/School/SearchServlet?location=score" method="post">
						...
						<c:choose>
							...
							<c:when test="${! empty ssbList }">
								<c:forEach items="${ssbList }" var="ssb">
									...
									<tr class="gradeX">
										<form action="/School/UpdateStudentScoreServlet" method="post">
										<td class="center"><c:out value="${ssb.course_no }"></c:out>
											<input type="hidden" value="${ssb.course_no }" id="course_no"
											name="course_no"></td>
										<td class="center"><c:out value="${ssb.course_name }"></c:out></td>
										<td class="center"><c:out value="${ssb.stu_no }"></c:out>
											<input type="hidden" value="${ssb.stu_no }" id="stu_no"
											name="stu_no"></td>
										<td class="center"><c:out value="${ssb.stu_name }"></c:out></td>
										<td class="center"><input type="text"
											value="${ssb.score }" id="score" name="score"></td>
										<td><button class="stdbtn btn_yellow" type="submit">打分</button></td>
										</form>
									</tr>
				...
				<br /> <br />
				<div align="center">
					<a href="/School/ShowStudentScoreServlet?page=first"><button
							class="stdbtn btn_yellow">首页</button></a><a
						href="/School/ShowStudentScoreServlet?page=previous"><button
							class="stdbtn btn_yellow">上一页</button></a><a
						href="/School/ShowStudentScoreServlet?page=next"><button
							class="stdbtn btn_yellow">下一页</button></a> <a
						href="/School/ShowStudentScoreServlet?page=last"><button
							class="stdbtn btn_yellow">尾页</button></a>
