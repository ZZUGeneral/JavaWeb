	...
	<div class="bodywrapper">
		...
		<div class="centercontent tables">
			...
			<div id="contentwrapper" class="contentwrapper">
				<form action="/School/SearchServlet?location=student" method="post">
								...
								<c:forEach items="${stuList }" var="stu">
									<tr class="gradeX">
										...
										<td class="center">
											<ul class="buttonlist">
												<li><a
													href="/School/StudentDetailServlet?stuNo=${stu.stu_no }"
				...
				<br /> <br />
				<div align="center">
					<a href="/School/StudentBasicinfoServlet?page=first"><button
							class="stdbtn btn_yellow">首页</button></a><a
						href="/School/StudentBasicinfoServlet?page=previous"><button
							class="stdbtn btn_yellow">上一页</button></a><a
						href="/School/StudentBasicinfoServlet?page=next"><button
							class="stdbtn btn_yellow">下一页</button></a> <a
						href="/School/StudentBasicinfoServlet?page=last"><button
