				...
				<div id="validation" class="subcontent">
					...
					<c:if test="${! empty myself }">
						<form id="form1" class="stdform" method="post"
							action="/School/UpdateMyselfServlet">
							...
							<p>
								<label>性别</label> <span class="field"> <input
									...
									class="longinput" value="男" checked="${myself.gender == '男'}" />男
									<input type="radio" name="gender" id="gender" class="longinput"
							...
							<br />
							<div align="center">
								<a href="/School/MyselfServlet"><button
