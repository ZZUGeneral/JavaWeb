				...
				<table align="center" border="1" cellspacing="0" cellpadding="0">
					...
					<c:forEach items="${allFood }" var="food" varStatus="status" >  <!--status for循环脚标-->
						<tr >
							...
							<td>${food.type}</td>
							<td><a href="${ctx }/DishesManageServlet?TYPES=dishesUpdate&foodId=${food.foodId}">修改</a></td>
							<td><a href="${ctx }/DishesManageServlet?TYPES=dishesDel&foodId=${food.foodId}">刪除</a></td>
						</tr>
					</c:forEach>
					</tbody>
