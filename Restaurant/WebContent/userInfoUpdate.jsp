...
<body>
	...
	<div class="registration-form">
		<div class="container">
			<h3>基本信息</h3>
			<h3><font color="red">${user.updateResult}</font></h3>
			<div class="strip"></div>
					...
					<div class="reg">
						...
						<form action="UserInfoServlet?type=update" method="post"
							...
							<ul>
								...
								<li><input type="text" id="userId" name="userId" value="${user.userId }" disabled="true" readOnly="true">
							...
							<ul>
								...
								<li><input type="text" name="address" value="${user.address }"></li>
							</ul>
							<ul>
