			...
			<div id="contentwrapper" class="contentwrapper">
				<div id="validation" class="subcontent">
					<div id="contentwrapper" class="contentwrapper">
						...
						<form action="/StudentManager/ChangePasswordServlet" method="post">
							<!--contenttitle-->
							<table cellpadding="0" cellspacing="0" border="0"
								...
								<tbody>
									...
									<tr>
										...
										<td class="center"><input type="password"
											id="confirmPassword" name="confirmPassword" /></td>
									</tr>
									<tr>
										<td align="center">验证码</td>
										<td class="center"><input class="tn-textbox-long"
											type="text" name="verifyCode" id="verifyCode"> <img
											src="ValidateCodeServlet" id="validateCode" title="点击换一换"
											onclick="changeValidateCode()"> <a
											href="javascript:changeValidateCode();">看不清？</a></td>
									</tr>
							...
							<div align="center">
								<p class="stdformbutton">
									<a href="/index.jsp"><button class="submit radius2">返回上一级</button></a>
								</p>
								<p class="stdformbutton">
									<input class="submit radius2" type="submit" value="保存更改">
								</p>
							</div>
							<br /> <br />
						</form>
