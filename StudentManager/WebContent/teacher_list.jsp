	...
	<div class="bodywrapper">
		...
		<div class="centercontent tables">
			...
			<div class="pageheader notab">
				<h1 class="pagetitle">教师信息</h1>
			</div>
			<!--pageheader-->
			<div id="contentwrapper" class="contentwrapper">
				<form action="/StudentManager/SearchServlet?location=teacher"
					method="post">
								...
								<c:forEach items="${teacherList }" var="teacher">
									<tr class="gradeX">
										...
										<td class="center">
											<ul class="buttonlist">
												<li><a
													href="/StudentManager/TeacherDetailServlet?teacherNo=${teacher.teacher_no }"
													class="btn btn_book"><span>详情</span></a></li>
												<c:if test="${identity=='admin' }">
													<li><a
														href="/StudentManager/DeleteTeacherServlet?teacherNo=${teacher.teacher_no }"
				...
				<br /> <br />
				<div align="center">
					<a href="/StudentManager/TeacherBasicinfoServlet?page=first"><button
							class="stdbtn btn_yellow">首页</button></a><a
						href="/StudentManager/TeacherBasicinfoServlet?page=previous"><button
							class="stdbtn btn_yellow">上一页</button></a><a
						href="/StudentManager/TeacherBasicinfoServlet?page=next"><button
							class="stdbtn btn_yellow">下一页</button></a> <a
						href="/StudentManager/TeacherBasicinfoServlet?page=last"><button
