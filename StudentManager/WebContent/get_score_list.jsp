...
<script type="text/javascript">
	function updateScore() {
		...
		window.location = "/StudentManager/StudentScoreServlet?updateScore="
	...
	<div class="bodywrapper">
		...
		<div class="centercontent tables">
			...
			<div id="contentwrapper" class="contentwrapper">
						...
						<c:choose>
							...
							<c:when test="${! empty ssbList }">
								<c:forEach items="${ssbList }" var="ssb">
									...
									<tr class="gradeX">
										<form action="/StudentManager/UpdateStudentScoreServlet"
											method="post">
											<td class="center"><c:out value="${ssb.course_no }"></c:out>
												<input type="hidden" value="${ssb.course_no }"
												id="course_no" name="course_no"></td>
				...
				<br /> <br />
				<div align="center">
					<a href="/StudentManager/ShowStudentScoreServlet?page=first"><button
							class="stdbtn btn_yellow">首页</button></a><a
						href="/StudentManager/ShowStudentScoreServlet?page=previous"><button
							class="stdbtn btn_yellow">上一页</button></a><a
						href="/StudentManager/ShowStudentScoreServlet?page=next"><button
							class="stdbtn btn_yellow">下一页</button></a> <a
						href="/StudentManager/ShowStudentScoreServlet?page=last"><button
