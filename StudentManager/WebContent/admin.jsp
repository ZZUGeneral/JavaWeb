			...
			<ul>
				<li><a href="#formsub" class="editor">学生管理</a> <span
					...
					<ul id="formsub">
						...
						<li><a href="/StudentManager/register.jsp?type=student">添加学生</a></li>
					</ul></li>

				<li><a href="#error" class="error">教师管理</a> <span class="arrow"></span>
					<ul id="error">
						<li><a
							href="/StudentManager/TeacherBasicinfoServlet?page=first">教师基本信息</a></li>
						<li><a
							href="/StudentManager/register.jsp?type=teacher">添加教师</a></li>
						<li><a
