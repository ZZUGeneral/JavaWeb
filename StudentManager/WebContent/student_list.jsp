	...
	<div class="bodywrapper">
		<div class="topheader">
			...
			<div class="right">
				...
				<div class="userinfo">
					<img src="/StudentManager/images/thumbs/avatar.png" alt="" /> <span>
						<c:out value="${identity }"></c:out>
					</span>
				</div>
				<!--userinfo-->
		...
		<div class="centercontent tables">
			...
			<div id="contentwrapper" class="contentwrapper">
				<form action="/StudentManager/SearchServlet?location=student"
					method="post">
				...
				<table cellpadding="0" cellspacing="0" border="0" class="stdtable"
					...
					<thead>
						<tr>
							...
							<th class="head0">院系</th>
							<th class="head0">其他操作</th>
						</tr>
					</thead>
					<tfoot>
						<tr>
						...
						<c:choose>
							...
							<c:when test="${! empty stuList }">
								<c:forEach items="${stuList }" var="stu">
									<tr class="gradeX">
										<td class="center"><c:out value="${stu.stu_no }"></c:out></td>
										<td class="center"><c:out value="${stu.stu_name }"></c:out></td>
										<td class="center"><c:out value="${stu.gender }"></c:out></td>
										<td class="center"><c:out value="${stu.dept }"></c:out></td>
										<td class="center">
											<ul class="buttonlist">
												<li><a
													href="/StudentManager/StudentDetailServlet?stuNo=${stu.stu_no }"
													class="btn btn_book"><span>详情</span></a></li>
												<c:if test="${identity=='admin' }">
													<li><a
														href="/StudentManager/DeleteStudentServlet?stuNo=${stu.stu_no }"
				...
				<br /> <br />
				<div align="center">
					<a href="/StudentManager/StudentBasicinfoServlet?page=first"><button
							class="stdbtn btn_yellow">首页</button></a><a
						href="/StudentManager/StudentBasicinfoServlet?page=previous"><button
							class="stdbtn btn_yellow">上一页</button></a><a
						href="/StudentManager/StudentBasicinfoServlet?page=next"><button
							class="stdbtn btn_yellow">下一页</button></a> <a
						href="/StudentManager/StudentBasicinfoServlet?page=last"><button
