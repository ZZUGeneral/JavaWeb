	...
	<div class="bodywrapper">
		...
		<div class="centercontent tables">
			...
			<div id="contentwrapper" class="contentwrapper">
				...
				<br /> <br />
				<div align="center">
					<a href="/StudentManager/StudentChooseCourseServlet?page=first"><button
							class="stdbtn btn_yellow">首页</button></a><a
						href="/StudentManager/StudentChooseCourseServlet?page=previous"><button
							class="stdbtn btn_yellow">上一页</button></a><a
						href="/StudentManager/StudentChooseCourseServlet?page=next"><button
							class="stdbtn btn_yellow">下一页</button></a> <a
						href="/StudentManager/StudentChooseCourseServlet?page=last"><button
