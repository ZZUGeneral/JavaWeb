...
public class ExTracePersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ExTrace";
	...
	private ExTracePersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(model.TransNode.class);
		configuration.addAnnotatedClass(model.Region.class);
		configuration.addAnnotatedClass(model.UserInfo.class);
		configuration.addAnnotatedClass(model.CustomerInfo.class);
		configuration.addAnnotatedClass(model.Posion.class);
		configuration.addAnnotatedClass(model.TransHistory.class);
		configuration.addAnnotatedClass(model.TransPackage.class);
		configuration.addAnnotatedClass(model.ExpreesSheet.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ExTracePersistentManager();
		}
